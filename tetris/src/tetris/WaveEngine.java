...
class WaveEngine {
     ...
     */
    private static void load(URL url) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        // オーディオストリームを開く
     ...
     */
    static void load(String filename) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
