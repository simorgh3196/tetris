...
public abstract class Block {
    ...
    public static final int TYPE_GHOST_BLOCK = 2;
        ...
        switch (dir) {
            case LEFT:
                ...
                if (board.isMovable(newPos, block)) {
                    pos = newPos;
                    board.paintGhostBlock(newPos, block, imageNo);
                }
                break;
            case RIGHT:
     ...
     */
    public int drop() {
    	Point newPos = board.getFallingPosition(pos, block);
    	int diff = newPos.y - pos.y;
    	pos = newPos;
    	board.fixBlock(newPos, block, imageNo);
